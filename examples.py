...
params = periphery_config.set_relay_enable_ant(2, 10) # от какой антенны вкл/выкл реле в метод передаем значение и номер блока реле
...
# system.saving_settings() # - сохранение настроек
